  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="glass border-b px-4 py-3 safe-area-top sticky top-0 z-20">
        ...
        {/* Tabs */}
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'hygiene' | 'allocations')} className="mt-3">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value="hygiene" className="gap-1.5">
              <SprayCanIcon className="w-4 h-4" />
              Higienização
            </TabsTrigger>
